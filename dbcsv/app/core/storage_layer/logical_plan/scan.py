...
class Scan(LogicalPlan):
    def __init__(self, schema: str, table: str, metadata: dict[str, str], batch_size: int = 1000, limit: int = None):
    ...
    def execute(self) -> 'TableIterator':
        return TableIterator(self.schema_name, self.table_name, self._metadata, self.batch_size, self.limit)
